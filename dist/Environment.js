...
exports.DLDB_PUBLIC_URL = exports.DLDB_PUBLIC_HOST = exports.DLDB_SEND_DELAY = exports.DLDB_MINIMUM_NETWORK_DELAY = exports.DLDB_INCOMING_SECRET = exports.DLDB_NODES = exports.DLDB_PORT = exports.DLDB_HOSTNAME = void 0;
 ...
 */
exports.DLDB_MINIMUM_NETWORK_DELAY = parseInt((_k = (_j = process === null || process === void 0 ? void 0 : process.env) === null || _j === void 0 ? void 0 : _j.DLDB_MINIMUM_NETWORK_DELAY) !== null && _k !== void 0 ? _k : '1', 10);
/**
 * Delay to wait until sending the data to remote node(s) in milliseconds.
 */
exports.DLDB_SEND_DELAY = parseInt((_m = (_l = process === null || process === void 0 ? void 0 : process.env) === null || _l === void 0 ? void 0 : _l.DLDB_SEND_DELAY) !== null && _m !== void 0 ? _m : '300', 10);
/**
 * Public host for local DLDB node, eg. hostname[:port] and defaults to localhost:{DLDB_PORT}
 */
exports.DLDB_PUBLIC_HOST = (_p = (_o = process === null || process === void 0 ? void 0 : process.env) === null || _o === void 0 ? void 0 : _o.DLDB_PUBLIC_HOST) !== null && _p !== void 0 ? _p : "localhost:" + exports.DLDB_PORT;
/**
 * Public URL for local DLDB node, eg. http://hostname[:port] and defaults to http://{DLDB_PUBLIC_HOST}
 */
exports.DLDB_PUBLIC_URL = (_r = (_q = process === null || process === void 0 ? void 0 : process.env) === null || _q === void 0 ? void 0 : _q.DLDB_PUBLIC_URL) !== null && _r !== void 0 ? _r : "http://" + exports.DLDB_PUBLIC_HOST;
